  ...
  const states = useEditorState({
    ...
    selector: (ctx) => {
      ...
      return {
        ...
        currentBorderRadius:
          Number(ctx.editor.getAttributes("section")?.borderRadius) ||
          DEFAULT_SECTION_BORDER_RADIUS,
        ...
        currentBorderColor:
          ...
          DEFAULT_SECTION_BORDER_COLOR,
        currentBorderWidth:
          Number(ctx.editor.getAttributes("section")?.borderWidth) ||
          DEFAULT_SECTION_BORDER_WIDTH,

        currentMarginTop:
          Number(ctx.editor.getAttributes("section")?.marginTop) ||
          DEFAULT_SECTION_MARGIN_TOP,
        currentMarginRight:
          Number(ctx.editor.getAttributes("section")?.marginRight) ||
          DEFAULT_SECTION_MARGIN_RIGHT,
        currentMarginBottom:
          Number(ctx.editor.getAttributes("section")?.marginBottom) ||
          DEFAULT_SECTION_MARGIN_BOTTOM,
        currentMarginLeft:
          Number(ctx.editor.getAttributes("section")?.marginLeft) ||
          DEFAULT_SECTION_MARGIN_LEFT,

        currentPaddingTop:
          Number(ctx.editor.getAttributes("section")?.paddingTop) ||
          DEFAULT_SECTION_PADDING_TOP,
        currentPaddingRight:
          Number(ctx.editor.getAttributes("section")?.paddingRight) ||
          DEFAULT_SECTION_PADDING_RIGHT,
        currentPaddingBottom:
          Number(ctx.editor.getAttributes("section")?.paddingBottom) ||
          DEFAULT_SECTION_PADDING_BOTTOM,
        currentPaddingLeft:
          Number(ctx.editor.getAttributes("section")?.paddingLeft) ||
          DEFAULT_SECTION_PADDING_LEFT,
