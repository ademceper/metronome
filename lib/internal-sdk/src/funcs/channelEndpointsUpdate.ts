...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ChannelEndpointsControllerUpdateChannelEndpointRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.ChannelEndpointsControllerUpdateChannelEndpointResponse$inboundSchema,
