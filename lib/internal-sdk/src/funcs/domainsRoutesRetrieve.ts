 ...
 */
export function domainsRoutesRetrieve(
  client: NovuCore,
  domain: string,
  address: string,
  ...
  >
> {
  return new APIPromise($do(client, domain, address, idempotencyKey, options))
}
...
> {
  const input: operations.DomainsControllerGetDomainRouteRequest = {
    domain: domain,
    address: address,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.DomainsControllerGetDomainRouteRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.DomainsControllerGetDomainRouteResponse$inboundSchema,
