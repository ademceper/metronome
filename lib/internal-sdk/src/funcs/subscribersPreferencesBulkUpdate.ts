...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.SubscribersControllerBulkUpdateSubscriberPreferencesRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.SubscribersControllerBulkUpdateSubscriberPreferencesResponse$inboundSchema,
