...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.EnvironmentVariablesControllerGetEnvironmentVariableRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.EnvironmentVariablesControllerGetEnvironmentVariableResponse$inboundSchema,
