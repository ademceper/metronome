...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SubscribersControllerCompleteNotificationActionRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.SubscribersControllerCompleteNotificationActionResponse$inboundSchema,
