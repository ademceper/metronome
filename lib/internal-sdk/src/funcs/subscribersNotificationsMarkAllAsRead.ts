...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.SubscribersControllerMarkAllNotificationsAsReadRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.nil(
      204,
      operations.SubscribersControllerMarkAllNotificationsAsReadResponse$inboundSchema.optional()
    ),
