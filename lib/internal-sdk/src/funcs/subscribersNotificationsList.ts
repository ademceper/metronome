...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SubscribersControllerGetSubscriberNotificationsRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.SubscribersControllerGetSubscriberNotificationsResponse$inboundSchema,
