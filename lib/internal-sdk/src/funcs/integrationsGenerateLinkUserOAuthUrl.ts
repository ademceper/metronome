...
> {
  return new APIPromise(
    $do(client, generateLinkUserOauthUrlRequestDto, idempotencyKey, options)
  )
}
...
> {
  const input: operations.IntegrationsControllerGenerateLinkUserOAuthUrlRequest =
    {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.IntegrationsControllerGenerateLinkUserOAuthUrlRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      201,
      operations.IntegrationsControllerGenerateLinkUserOAuthUrlResponse$inboundSchema,
