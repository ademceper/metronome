...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ChannelConnectionsControllerUpdateChannelConnectionRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.ChannelConnectionsControllerUpdateChannelConnectionResponse$inboundSchema,
