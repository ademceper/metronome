...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.EnvironmentsControllerV1ListMyEnvironmentsRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.EnvironmentsControllerV1ListMyEnvironmentsResponse$inboundSchema,
