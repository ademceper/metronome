...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.SubscribersControllerArchiveAllReadNotificationsRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.nil(
      204,
      operations.SubscribersControllerArchiveAllReadNotificationsResponse$inboundSchema.optional()
    ),
