...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SubscribersControllerMarkNotificationAsUnreadRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.SubscribersControllerMarkNotificationAsUnreadResponse$inboundSchema,
