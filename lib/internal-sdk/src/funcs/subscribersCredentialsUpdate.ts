...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.SubscribersV1ControllerUpdateSubscriberChannelRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.SubscribersV1ControllerUpdateSubscriberChannelResponse$inboundSchema,
