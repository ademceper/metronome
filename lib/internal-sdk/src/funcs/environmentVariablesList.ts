...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.EnvironmentVariablesControllerListEnvironmentVariablesRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.EnvironmentVariablesControllerListEnvironmentVariablesResponse$inboundSchema,
