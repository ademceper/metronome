...
> {
  return new APIPromise(
    $do(client, createTranslationRequestDto, idempotencyKey, options)
  )
}
...
> {
  const input: operations.TranslationControllerCreateTranslationEndpointRequest =
    {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.TranslationControllerCreateTranslationEndpointRequest$outboundSchema.parse(
        value
      ),
