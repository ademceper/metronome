...
> {
  return new APIPromise(
    $do(client, createEnvironmentRequestDto, idempotencyKey, options)
  )
}
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.EnvironmentsControllerV1CreateEnvironmentRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      201,
      operations.EnvironmentsControllerV1CreateEnvironmentResponse$inboundSchema,
