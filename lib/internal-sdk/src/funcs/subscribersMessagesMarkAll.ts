...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.SubscribersV1ControllerMarkAllUnreadAsReadRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      201,
      operations.SubscribersV1ControllerMarkAllUnreadAsReadResponse$inboundSchema,
