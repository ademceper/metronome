...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SubscribersControllerUnarchiveNotificationRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.SubscribersControllerUnarchiveNotificationResponse$inboundSchema,
