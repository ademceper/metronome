...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.EnvironmentVariablesControllerGetEnvironmentVariableUsageRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.EnvironmentVariablesControllerGetEnvironmentVariableUsageResponse$inboundSchema,
