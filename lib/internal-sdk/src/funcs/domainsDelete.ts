...
export function domainsDelete(
  ...
  Result<
    operations.DomainsControllerDeleteDomainResponse | undefined,
    | errors.ErrorDto
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.DomainsControllerDeleteDomainRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.nil(
      204,
      operations.DomainsControllerDeleteDomainResponse$inboundSchema.optional(),
      { hdrs: true }
    ),
