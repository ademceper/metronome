...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SubscribersControllerRevertNotificationActionRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.SubscribersControllerRevertNotificationActionResponse$inboundSchema,
