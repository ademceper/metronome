...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.IntegrationsControllerAutoConfigureIntegrationRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.IntegrationsControllerAutoConfigureIntegrationResponse$inboundSchema,
