...
> {
  return new APIPromise(
    $do(client, createEnvironmentVariableRequestDto, idempotencyKey, options)
  )
}
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.EnvironmentVariablesControllerCreateEnvironmentVariableRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.EnvironmentVariablesControllerCreateEnvironmentVariableResponse$inboundSchema,
