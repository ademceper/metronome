...
> {
  return new APIPromise(
    $do(client, bulkSubscriberCreateDto, idempotencyKey, options)
  )
}
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.SubscribersV1ControllerBulkCreateSubscribersRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      201,
      operations.SubscribersV1ControllerBulkCreateSubscribersResponse$inboundSchema,
