...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SubscribersControllerListSubscriberTopicsRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.SubscribersControllerListSubscriberTopicsResponse$inboundSchema,
