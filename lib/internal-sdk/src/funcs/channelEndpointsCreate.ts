...
> {
  const input: operations.ChannelEndpointsControllerCreateChannelEndpointRequest =
    {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ChannelEndpointsControllerCreateChannelEndpointRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      201,
      operations.ChannelEndpointsControllerCreateChannelEndpointResponse$inboundSchema,
