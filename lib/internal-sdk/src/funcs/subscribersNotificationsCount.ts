...
> {
  return new APIPromise(
    $do(client, subscriberId, filters, idempotencyKey, options)
  )
}
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.SubscribersControllerGetSubscriberNotificationsCountRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.SubscribersControllerGetSubscriberNotificationsCountResponse$inboundSchema,
