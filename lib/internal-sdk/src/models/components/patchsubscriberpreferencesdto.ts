...
/** @internal */
export const Two$outboundSchema: z.ZodType<Two$Outbound, z.ZodTypeDef, Two> =
  z.object({
    id: z.string(),
...
> = z.object({
  ...
  context: z
    .record(z.union([z.lazy(() => Two$outboundSchema), z.string()]))
    .optional(),
})
