...
import {
  type HttpRequestStepResponseDto,
...
> = z
  .object({
    ...
    createdAt: z.string(),
    updatedBy: z
      .nullable(z.lazy(() => WorkflowResponseDtoUpdatedBy$inboundSchema))
      .optional(),
    lastPublishedAt: z.nullable(z.string()).optional(),
    lastPublishedBy: z
      .nullable(z.lazy(() => LastPublishedBy$inboundSchema))
      .optional(),
    steps: z.array(
      discriminatedUnion("type", {
        in_app: InAppStepResponseDto$inboundSchema,
