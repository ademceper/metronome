...
import { type EmailBlock, EmailBlock$inboundSchema } from "./emailblock.js"
import { type MessageCTA, MessageCTA$inboundSchema } from "./messagecta.js"
import {
...
> = z
  .object({
    ...
    content: z
      .nullable(z.union([z.array(EmailBlock$inboundSchema), z.string()]))
      .optional(),
