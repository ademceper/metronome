...
import {
  type DeleteTopicSubscriberIdentifierDto,
  type DeleteTopicSubscriberIdentifierDto$Outbound,
...
export type DeleteTopicSubscriptionsRequestDto = {
   ...
   */
  subscriptions?: Array<string | DeleteTopicSubscriberIdentifierDto> | undefined
}
...
/** @internal */
export const DeleteTopicSubscriptionsRequestDtoSubscriptions$outboundSchema: z.ZodType<
...
export function deleteTopicSubscriptionsRequestDtoSubscriptionsToJSON(
  deleteTopicSubscriptionsRequestDtoSubscriptions: DeleteTopicSubscriptionsRequestDtoSubscriptions
): string {
