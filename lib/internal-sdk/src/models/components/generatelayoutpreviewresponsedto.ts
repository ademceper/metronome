...
/** @internal */
export const ResultType$inboundSchema: z.ZodNativeEnum<typeof ResultType> =
  z.nativeEnum(ResultType)
...
/** @internal */
export const Result$inboundSchema: z.ZodType<Result, z.ZodTypeDef, unknown> =
