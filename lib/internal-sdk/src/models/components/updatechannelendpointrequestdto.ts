...
export function updateChannelEndpointRequestDtoEndpointToJSON(
  updateChannelEndpointRequestDtoEndpoint: UpdateChannelEndpointRequestDtoEndpoint
): string {
