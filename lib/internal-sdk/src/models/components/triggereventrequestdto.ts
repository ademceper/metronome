...
import {
  ...
  type EmailChannelOverrides$Outbound,
...
export type TriggerEventRequestDto = {
  ...
  context?: { [k: string]: TriggerEventRequestDtoContext2 | string } | undefined
}
...
/** @internal */
export const To1$outboundSchema: z.ZodType<To1$Outbound, z.ZodTypeDef, To1> =
  z.union([
    TopicPayloadDto$outboundSchema,
    SubscriberPayloadDto$outboundSchema,
    z.string(),
...
> = z
  .object({
    ...
    actor: z
      .union([SubscriberPayloadDto$outboundSchema, z.string()])
      .optional(),
