...
/** @internal */
export const Issues$inboundSchema: z.ZodType<Issues, z.ZodTypeDef, unknown> =
  z.object({})
...
> = z
  .object({
    ...
    metadata: z
      .lazy(() => ActivityNotificationStepResponseDtoMetadata$inboundSchema)
      .optional(),
    ...
    variants: z
      .array(z.lazy(() => ActivityNotificationStepResponseDto$inboundSchema))
      .optional(),
