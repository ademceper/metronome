...
import {
  ...
  type GroupPreferenceFilterDto$Outbound,
  GroupPreferenceFilterDto$outboundSchema,
} from "./grouppreferencefilterdto.js"
import {
  type WorkflowPreferenceRequestDto,
  type WorkflowPreferenceRequestDto$Outbound,
...
/** @internal */
export const UpdateTopicSubscriptionRequestDtoPreferences$outboundSchema: z.ZodType<
...
export function updateTopicSubscriptionRequestDtoPreferencesToJSON(
  updateTopicSubscriptionRequestDtoPreferences: UpdateTopicSubscriptionRequestDtoPreferences
): string {
