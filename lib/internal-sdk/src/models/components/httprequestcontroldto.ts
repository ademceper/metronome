...
import {
  ...
  type HttpRequestKeyValuePairDto$Outbound,
...
/** @internal */
export const Body$inboundSchema: z.ZodType<Body, z.ZodTypeDef, unknown> =
...
> = z.object({
  ...
  body: z
    .union([z.string(), z.array(HttpRequestKeyValuePairDto$outboundSchema)])
    .optional(),
  responseBodySchema: z.record(z.any()).optional(),
  enforceSchemaValidation: z.boolean().optional(),
  continueOnFailure: z.boolean().optional(),
