...
/** @internal */
export const ChannelConnectionsControllerGetChannelConnectionByIdentifierRequest$outboundSchema: z.ZodType<
...
export function channelConnectionsControllerGetChannelConnectionByIdentifierRequestToJSON(
  channelConnectionsControllerGetChannelConnectionByIdentifierRequest: ChannelConnectionsControllerGetChannelConnectionByIdentifierRequest
): string {
  return JSON.stringify(
    ChannelConnectionsControllerGetChannelConnectionByIdentifierRequest$outboundSchema.parse(
      channelConnectionsControllerGetChannelConnectionByIdentifierRequest
    )
  )
}
...
/** @internal */
export const ChannelConnectionsControllerGetChannelConnectionByIdentifierResponse$inboundSchema: z.ZodType<
...
> {
  return safeParse(
    jsonString,
    (x) =>
      ChannelConnectionsControllerGetChannelConnectionByIdentifierResponse$inboundSchema.parse(
        JSON.parse(x)
      ),
