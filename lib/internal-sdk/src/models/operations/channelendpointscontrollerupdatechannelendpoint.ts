...
export type ChannelEndpointsControllerUpdateChannelEndpointRequest$Outbound = {
  ...
  UpdateChannelEndpointRequestDto: components.UpdateChannelEndpointRequestDto$Outbound
}

/** @internal */
export const ChannelEndpointsControllerUpdateChannelEndpointRequest$outboundSchema: z.ZodType<
...
export function channelEndpointsControllerUpdateChannelEndpointRequestToJSON(
  channelEndpointsControllerUpdateChannelEndpointRequest: ChannelEndpointsControllerUpdateChannelEndpointRequest
): string {
...
/** @internal */
export const ChannelEndpointsControllerUpdateChannelEndpointResponse$inboundSchema: z.ZodType<
...
> {
  return safeParse(
    jsonString,
    (x) =>
      ChannelEndpointsControllerUpdateChannelEndpointResponse$inboundSchema.parse(
        JSON.parse(x)
      ),
