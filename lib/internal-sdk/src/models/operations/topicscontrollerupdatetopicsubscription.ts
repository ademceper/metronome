...
export type TopicsControllerUpdateTopicSubscriptionRequest$Outbound = {
  ...
  UpdateTopicSubscriptionRequestDto: components.UpdateTopicSubscriptionRequestDto$Outbound
}

/** @internal */
export const TopicsControllerUpdateTopicSubscriptionRequest$outboundSchema: z.ZodType<
...
export function topicsControllerUpdateTopicSubscriptionRequestToJSON(
  topicsControllerUpdateTopicSubscriptionRequest: TopicsControllerUpdateTopicSubscriptionRequest
): string {
...
/** @internal */
export const TopicsControllerUpdateTopicSubscriptionResponse$inboundSchema: z.ZodType<
