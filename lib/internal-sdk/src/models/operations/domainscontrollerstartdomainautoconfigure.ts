...
export type DomainsControllerStartDomainAutoConfigureRequest$Outbound = {
  ...
  CreateDomainConnectApplyUrlDto: components.CreateDomainConnectApplyUrlDto$Outbound
}

/** @internal */
export const DomainsControllerStartDomainAutoConfigureRequest$outboundSchema: z.ZodType<
...
export function domainsControllerStartDomainAutoConfigureRequestToJSON(
  domainsControllerStartDomainAutoConfigureRequest: DomainsControllerStartDomainAutoConfigureRequest
): string {
...
/** @internal */
export const DomainsControllerStartDomainAutoConfigureResponse$inboundSchema: z.ZodType<
