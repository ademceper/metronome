...
/** @internal */
export const ChannelEndpointsControllerListChannelEndpointsQueryParamOrderDirection$outboundSchema: z.ZodNativeEnum<
  typeof ChannelEndpointsControllerListChannelEndpointsQueryParamOrderDirection
> = z.nativeEnum(
  ChannelEndpointsControllerListChannelEndpointsQueryParamOrderDirection
)
...
/** @internal */
export const ChannelEndpointsControllerListChannelEndpointsRequest$outboundSchema: z.ZodType<
...
> = z
  .object({
    ...
    orderDirection:
      ChannelEndpointsControllerListChannelEndpointsQueryParamOrderDirection$outboundSchema.optional(),
...
export function channelEndpointsControllerListChannelEndpointsRequestToJSON(
  channelEndpointsControllerListChannelEndpointsRequest: ChannelEndpointsControllerListChannelEndpointsRequest
): string {
...
/** @internal */
export const ChannelEndpointsControllerListChannelEndpointsResponse$inboundSchema: z.ZodType<
...
> {
  return safeParse(
    jsonString,
    (x) =>
      ChannelEndpointsControllerListChannelEndpointsResponse$inboundSchema.parse(
        JSON.parse(x)
      ),
