...
/** @internal */
export const DomainsControllerGetDomainAutoConfigureRequest$outboundSchema: z.ZodType<
...
export function domainsControllerGetDomainAutoConfigureRequestToJSON(
  domainsControllerGetDomainAutoConfigureRequest: DomainsControllerGetDomainAutoConfigureRequest
): string {
...
/** @internal */
export const DomainsControllerGetDomainAutoConfigureResponse$inboundSchema: z.ZodType<
