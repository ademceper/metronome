...
export class ChannelConnections extends ClientSDK {
  ...
  ): Promise<operations.ChannelConnectionsControllerListChannelConnectionsResponse> {
    return unwrapAsync(channelConnectionsList(this, request, options))
  }
  ...
  async create(
    ...
    options?: RequestOptions
  ): Promise<operations.ChannelConnectionsControllerCreateChannelConnectionResponse> {
    return unwrapAsync(
  ...
  async retrieve(
    ...
    idempotencyKey?: string | undefined,
    options?: RequestOptions
  ): Promise<operations.ChannelConnectionsControllerGetChannelConnectionByIdentifierResponse> {
    return unwrapAsync(
      channelConnectionsRetrieve(this, identifier, idempotencyKey, options)
    )
  }
  ...
  async update(
    ...
    idempotencyKey?: string | undefined,
    options?: RequestOptions
  ): Promise<operations.ChannelConnectionsControllerUpdateChannelConnectionResponse> {
    return unwrapAsync(
  ...
  > {
    return unwrapAsync(
      channelConnectionsDelete(this, identifier, idempotencyKey, options)
    )
  }
}
