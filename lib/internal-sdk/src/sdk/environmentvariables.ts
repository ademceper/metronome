...
export class EnvironmentVariables extends ClientSDK {
  ...
  async list(
    ...
    return unwrapAsync(
      environmentVariablesList(this, search, idempotencyKey, options)
    )
  }
  ...
  async retrieve(
    ...
    return unwrapAsync(
      environmentVariablesRetrieve(this, variableKey, idempotencyKey, options)
    )
  }
  ...
  > {
    return unwrapAsync(
      environmentVariablesDelete(this, variableKey, idempotencyKey, options)
    )
  }
  ...
  async usage(
    ...
    return unwrapAsync(
      environmentVariablesUsage(this, variableKey, idempotencyKey, options)
    )
  }
}
