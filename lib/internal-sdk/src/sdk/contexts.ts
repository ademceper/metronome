...
export class Contexts extends ClientSDK {
  ...
  async create(
    ...
    return unwrapAsync(
      contextsCreate(this, createContextRequestDto, idempotencyKey, options)
    )
  }
  ...
  async list(
    ...
    return unwrapAsync(contextsList(this, request, options))
  }
  ...
  async update(
    ...
    return unwrapAsync(contextsUpdate(this, request, options))
  }
  ...
  async retrieve(
    ...
    return unwrapAsync(
      contextsRetrieve(this, type, id, idempotencyKey, options)
    )
  }
  ...
  async delete(
    ...
    return unwrapAsync(contextsDelete(this, type, id, idempotencyKey, options))
  }
}
