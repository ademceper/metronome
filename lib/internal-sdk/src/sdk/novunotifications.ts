...
export class NovuNotifications extends ClientSDK {
  ...
  async completeAction(
    ...
    return unwrapAsync(
      subscribersNotificationsCompleteAction(this, request, options)
    )
  }
  ...
  async revertAction(
    ...
    return unwrapAsync(
      subscribersNotificationsRevertAction(this, request, options)
    )
  }
  ...
  async markAsRead(
    ...
    return unwrapAsync(
      subscribersNotificationsMarkAsRead(this, request, options)
    )
  }
  ...
  async unarchive(
    ...
    return unwrapAsync(
      subscribersNotificationsUnarchive(this, request, options)
    )
  }
  ...
  async markAsUnread(
    ...
    return unwrapAsync(
      subscribersNotificationsMarkAsUnread(this, request, options)
    )
  }
  ...
  async unseenCount(
    ...
    return unwrapAsync(
      subscribersNotificationsUnseenCount(this, request, options)
    )
  }
}
