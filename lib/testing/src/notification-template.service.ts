...
export class NotificationTemplateService {
  ...
  async createTemplate(override: Partial<CreateTemplatePayload> = {}) {
        ...
        content: [
          {
            ...
            content:
              "This are the text contents of the template for {{firstName}}",
          },
          {
    ...
    const notificationTemplate =
      await this.notificationTemplateRepository.create(data)
  ...
  async getBlueprintTemplates(
    ...
    const blueprintTemplates =
      await this.notificationTemplateRepository.findBlueprintTemplates(
        organizationId,
        environmentId
      )
