...
function createHandlebarsInstance(i18next: any) {
  ...
  handlebars.registerHelper(HandlebarHelpersEnum.UPPERCASE, (value) =>
    value?.toUpperCase()
  )

  handlebars.registerHelper(HandlebarHelpersEnum.LOWERCASE, (value) =>
    value?.toLowerCase()
  )

  handlebars.registerHelper(
    HandlebarHelpersEnum.PLURALIZE,
    (number, single, plural) => (number === 1 ? single : plural)
  )
  ...
  handlebars.registerHelper(HandlebarHelpersEnum.GT, (arg1, arg2, options) =>
    assertResult(arg1 > arg2, options)
  )

  handlebars.registerHelper(HandlebarHelpersEnum.GTE, (arg1, arg2, options) =>
    assertResult(arg1 >= arg2, options)
  )

  handlebars.registerHelper(HandlebarHelpersEnum.LT, (arg1, arg2, options) =>
    assertResult(arg1 < arg2, options)
  )

  handlebars.registerHelper(HandlebarHelpersEnum.LTE, (arg1, arg2, options) =>
    assertResult(arg1 <= arg2, options)
  )

  handlebars.registerHelper(HandlebarHelpersEnum.EQ, (arg1, arg2, options) =>
    assertResult(arg1 === arg2, options)
  )

  handlebars.registerHelper(HandlebarHelpersEnum.NE, (arg1, arg2, options) =>
    assertResult(arg1 !== arg2, options)
  )
