...
export class MergePreferences {
   ...
   */
  private static ensureDefaultAllEnabled(
    preference: PreferencesEntity | undefined
    ...
    if (
      ...
      normalized.preferences.all.enabled === undefined
    ) {
      normalized.preferences.all = {
        ...normalized.preferences.all,
        enabled: true,
  ...
  public static execute(
    ...
    const shouldExcludeSubscriberPreferences =
      command.excludeSubscriberPreferences || isWorkflowPreferenceReadonly
