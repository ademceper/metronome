...
describe("DurationUtils", () => {
  ...
  describe("convertToMilliseconds", () => {
    ...
    it("should throw error for invalid time unit", () => {
      expect(() => DurationUtils.convertToMilliseconds(5, "invalid")).toThrow(
        "Invalid time unit"
      )
      expect(() => DurationUtils.convertToMilliseconds(5, "years")).toThrow(
        "Invalid time unit"
      )
      expect(() => DurationUtils.convertToMilliseconds(5, "")).toThrow(
        "Invalid time unit"
      )
    })
