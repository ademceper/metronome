...
export function getStepResolverControlSchema(
...
export function reconcileStepResolverControlValues(
  ...
  let reconciledControlValues = cloneDeep(
    isPlainObject(controlValues) ? controlValues : {}
  )
  ...
  while (true) {
    ...
    for (const error of errors) {
      ...
      removedInvalidValue =
        removeAtJsonPointer(reconciledControlValues, removablePath) ||
        removedInvalidValue
    }
