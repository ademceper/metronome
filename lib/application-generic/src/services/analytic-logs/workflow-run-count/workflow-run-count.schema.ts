...
export const workflowRunCountSchema = new ClickhouseSchema(
  schemaDefinition,
  clickhouseSchemaOptions
)

type NativeWorkflowRunCount = InferClickhouseSchemaType<
  typeof workflowRunCountSchema
>

type WorkflowRunCountEventType =
  | WorkflowRunStatusType
  | DeliveryLifecycleEventType

export type WorkflowRunCountComplex = Omit<
  NativeWorkflowRunCount,
  "event_type"
> & {
