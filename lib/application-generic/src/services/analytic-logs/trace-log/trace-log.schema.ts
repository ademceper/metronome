...
export type TraceLogComplex = Omit<
  NativeTrace,
  "event_type" | "entity_type" | "status" | "step_run_type"
> & {
...
type AutoGeneratedFields = keyof Pick<
  Trace,
  "id" | "expires_at" | "entity_type"
>
...
export type RequestTraceInput = Prettify<
  Omit<
    Trace,
    AutoGeneratedFields | WorkflowRunExclusiveFields | StepRunExclusiveFields
  >
>

export type StepRunTraceInput = Prettify<
  Omit<Trace, AutoGeneratedFields | WorkflowRunExclusiveFields>
>

export type WorkflowRunTraceInput = Prettify<
  Omit<Trace, AutoGeneratedFields | StepRunExclusiveFields>
>
