...
describe("ParseSlugIdPipe", () => {
  ...
  describe("MongoDB ObjectIds", () => {
    it("should return MongoDB ObjectIds unchanged", () => {
      ...
      expect(pipe.transform(internalId, {} as ArgumentMetadata)).to.equal(
        internalId
      )
    })
  ...
  describe("Short resource identifiers", () => {
    it("should return short workflow identifiers unchanged", () => {
      ...
      expect(pipe.transform(identifier, {} as ArgumentMetadata)).to.equal(
        identifier
      )
    })
  ...
  describe("Slug IDs with various prefixes", () => {
    it("should decode workflow slug IDs", () => {
      ...
      expect(pipe.transform(slugId, {} as ArgumentMetadata)).to.equal(
        internalId
      )
    })
  ...
  describe("Internal IDs with leading zeros in slug format", () => {
    it("should handle decoded IDs with leading zeros", () => {
      const internalIds = [
        ...
        "0615943e7ace93b0540ae377",
        "0015943e7ace93b0540ae377",
      ]
  ...
  describe("Invalid or malformed inputs", () => {
    it("should return invalid slug IDs unchanged", () => {
      ...
      expect(pipe.transform(invalidSlugId, {} as ArgumentMetadata)).to.equal(
        invalidSlugId
      )
    })
    ...
    it("should return malformed slug IDs unchanged", () => {
      ...
      expect(pipe.transform(malformedSlugId, {} as ArgumentMetadata)).to.equal(
        malformedSlugId
      )
    })
    ...
    it("should handle undefined values", () => {
      expect(pipe.transform(undefined as any, {} as ArgumentMetadata)).to.equal(
        undefined
      )
    })
  ...
  describe("Edge cases", () => {
    it("should handle very long resource names in slug format", () => {
      ...
      const longResourceName =
        "very-long-resource-name-that-exceeds-normal-length"
    ...
    it("should prioritize exact matches over decoding attempts", () => {
      ...
      expect(pipe.transform(shortIdentifier, {} as ArgumentMetadata)).to.equal(
        shortIdentifier
      )
    })
  })
