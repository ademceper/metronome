...
import type { TranslationGroupEntity } from "./translation-group.entity"

const mongooseDelete = require("mongoose-delete")

export type TranslationGroupModel = ChangePropsValueType<
...
translationGroupSchema.plugin(mongooseDelete, {
  deletedAt: true,
  deletedBy: true,
  overrideMethods: "all",
})
...
export const TranslationGroup =
  mongoose.models.TranslationGroup ||
  mongoose.model<TranslationGroupModel>(
    "TranslationGroup",
