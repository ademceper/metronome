...
export class OrganizationRepository implements IOrganizationRepository {
  ...
  updateBrandingDetails(
    ...
    return this.organizationRepository.updateBrandingDetails(
      organizationId,
      branding
    )
  }
  ...
  renameOrganization(organizationId: string, payload: { name: string }) {
    return this.organizationRepository.renameOrganization(
      organizationId,
      payload
    )
  }
  ...
  updateDefaultLocale(
    ...
    return this.organizationRepository.updateDefaultLocale(
      organizationId,
      defaultLocale
    )
  }

  findByPartnerConfigurationId(args: {
    userId: string
  ...
  findBatch(
    ...
    return this.organizationRepository.findBatch(
      query,
      select,
      options,
      batchSize
