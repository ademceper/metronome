...
conversationActivitySchema.index(
  { _conversationId: 1, platformMessageId: 1 },
  { sparse: true }
)
conversationActivitySchema.index(
  { _environmentId: 1, identifier: 1 },
  { unique: true }
)

export const ConversationActivity =
  (mongoose.models
    .ConversationActivity as mongoose.Model<ConversationActivityDBModel>) ||
  mongoose.model<ConversationActivityDBModel>(
