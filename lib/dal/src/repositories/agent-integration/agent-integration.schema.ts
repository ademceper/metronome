...
import type { AgentIntegrationDBModel } from "./agent-integration.entity"
...
export const AgentIntegration =
  (mongoose.models
    .AgentIntegration as mongoose.Model<AgentIntegrationDBModel>) ||
  mongoose.model<AgentIntegrationDBModel>(
    "AgentIntegration",
