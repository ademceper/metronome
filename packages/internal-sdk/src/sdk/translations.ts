...
export class Translations extends ClientSDK {
  ...
  async retrieve(
    ...
    return unwrapAsync(translationsRetrieve(this, request, options))
  }
  ...
  async delete(
    ...
    return unwrapAsync(translationsDelete(this, request, options))
  }
  ...
  async upload(
    ...
    return unwrapAsync(
      translationsUpload(this, requestBody, idempotencyKey, options)
    )
  }
}
