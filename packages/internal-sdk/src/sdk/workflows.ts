...
export class Workflows extends ClientSDK {
  ...
  async create(
    ...
    return unwrapAsync(
      workflowsCreate(this, createWorkflowDto, idempotencyKey, options)
    )
  }
  ...
  async get(
    ...
    return unwrapAsync(
      workflowsGet(this, workflowId, environmentId, idempotencyKey, options)
    )
  }
  ...
  async delete(
    ...
    return unwrapAsync(
      workflowsDelete(this, workflowId, idempotencyKey, options)
    )
  }
  ...
  async sync(
    ...
    return unwrapAsync(
      workflowsSync(this, syncWorkflowDto, workflowId, idempotencyKey, options)
    )
  }
}
