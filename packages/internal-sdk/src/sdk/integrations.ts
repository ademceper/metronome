...
export class Integrations extends ClientSDK {
  ...
  async delete(
    ...
    return unwrapAsync(
      integrationsDelete(this, integrationId, idempotencyKey, options)
    )
  }
  ...
  async setAsPrimary(
    ...
    return unwrapAsync(
      integrationsSetAsPrimary(this, integrationId, idempotencyKey, options)
    )
  }
  ...
  async generateLinkUserOAuthUrl(
    ...
    idempotencyKey?: string | undefined,
    options?: RequestOptions
  ): Promise<operations.IntegrationsControllerGenerateLinkUserOAuthUrlResponse> {
    return unwrapAsync(
      integrationsGenerateLinkUserOAuthUrl(
        this,
