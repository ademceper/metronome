...
export class Routes extends ClientSDK {
  ...
  async list(
    ...
    return unwrapAsync(domainsRoutesList(this, request, options))
  }
  ...
  async create(
    ...
    return unwrapAsync(
      domainsRoutesCreate(this, domainRouteDto, domain, idempotencyKey, options)
    )
  }
  ...
  async retrieve(
    ...
    return unwrapAsync(
      domainsRoutesRetrieve(this, domain, address, idempotencyKey, options)
    )
  }
  ...
  > {
    return unwrapAsync(
      domainsRoutesDelete(this, domain, address, idempotencyKey, options)
    )
  }
