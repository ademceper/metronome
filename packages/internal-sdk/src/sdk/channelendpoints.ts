...
export class ChannelEndpoints extends ClientSDK {
  ...
  async list(
    ...
    return unwrapAsync(channelEndpointsList(this, request, options))
  }
  ...
  async create(
    ...
    return unwrapAsync(
      channelEndpointsCreate(this, requestBody, idempotencyKey, options)
    )
  }
  ...
  async retrieve(
    ...
    return unwrapAsync(
      channelEndpointsRetrieve(this, identifier, idempotencyKey, options)
    )
  }
  ...
  > {
    return unwrapAsync(
      channelEndpointsDelete(this, identifier, idempotencyKey, options)
    )
  }
}
