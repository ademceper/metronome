...
> {
  return new APIPromise(
    $do(client, domainRouteDto, domain, idempotencyKey, options)
  )
}
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.DomainsControllerCreateDomainRouteRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      201,
      operations.DomainsControllerCreateDomainRouteResponse$inboundSchema,
