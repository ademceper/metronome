...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SubscribersControllerUnsnoozeNotificationRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.SubscribersControllerUnsnoozeNotificationResponse$inboundSchema,
