...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SubscribersControllerGetSubscriberPreferencesRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.SubscribersControllerGetSubscriberPreferencesResponse$inboundSchema,
