...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SubscribersControllerDeleteNotificationRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.nil(
      204,
      operations.SubscribersControllerDeleteNotificationResponse$inboundSchema.optional()
    ),
