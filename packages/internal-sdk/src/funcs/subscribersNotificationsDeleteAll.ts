...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.SubscribersControllerDeleteAllNotificationsRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.nil(
      204,
      operations.SubscribersControllerDeleteAllNotificationsResponse$inboundSchema.optional()
    ),
