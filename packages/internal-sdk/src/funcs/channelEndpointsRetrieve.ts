...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ChannelEndpointsControllerGetChannelEndpointRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.ChannelEndpointsControllerGetChannelEndpointResponse$inboundSchema,
