...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ChannelEndpointsControllerListChannelEndpointsRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.ChannelEndpointsControllerListChannelEndpointsResponse$inboundSchema,
