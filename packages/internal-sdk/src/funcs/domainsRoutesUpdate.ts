...
> {
  return new APIPromise(
    $do(client, updateDomainRouteDto, domain, address, idempotencyKey, options)
  )
}
...
> {
  ...
  const body = encodeJSON("body", payload.UpdateDomainRouteDto, {
    explode: true,
  })
  ...
  >(
    M.json(
      200,
      operations.DomainsControllerUpdateDomainRouteResponse$inboundSchema,
