...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ChannelConnectionsControllerListChannelConnectionsRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.ChannelConnectionsControllerListChannelConnectionsResponse$inboundSchema,
