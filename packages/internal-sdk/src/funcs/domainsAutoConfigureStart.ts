...
> {
  return new APIPromise(
    $do(client, createDomainConnectApplyUrlDto, domain, idempotencyKey, options)
  )
}
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.DomainsControllerStartDomainAutoConfigureRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      201,
      operations.DomainsControllerStartDomainAutoConfigureResponse$inboundSchema,
