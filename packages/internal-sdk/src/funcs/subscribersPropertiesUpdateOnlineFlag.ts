...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.SubscribersV1ControllerUpdateSubscriberOnlineFlagRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.SubscribersV1ControllerUpdateSubscriberOnlineFlagResponse$inboundSchema,
