...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.SubscribersControllerArchiveAllNotificationsRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.nil(
      204,
      operations.SubscribersControllerArchiveAllNotificationsResponse$inboundSchema.optional()
    ),
