...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.EnvironmentsControllerV1DeleteEnvironmentRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.nil(
      200,
      operations.EnvironmentsControllerV1DeleteEnvironmentResponse$inboundSchema.optional()
    ),
