...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.IntegrationsControllerGetActiveIntegrationsRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.IntegrationsControllerGetActiveIntegrationsResponse$inboundSchema,
