...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.SubscribersControllerMarkNotificationsAsSeenRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.nil(
      204,
      operations.SubscribersControllerMarkNotificationsAsSeenResponse$inboundSchema.optional()
    ),
