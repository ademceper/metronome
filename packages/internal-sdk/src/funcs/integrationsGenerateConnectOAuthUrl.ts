...
> {
  return new APIPromise(
    $do(client, generateConnectOauthUrlRequestDto, idempotencyKey, options)
  )
}
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.IntegrationsControllerGenerateConnectOAuthUrlRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      201,
      operations.IntegrationsControllerGenerateConnectOAuthUrlResponse$inboundSchema,
