...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SubscribersControllerMarkNotificationAsReadRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.SubscribersControllerMarkNotificationAsReadResponse$inboundSchema,
