...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ChannelConnectionsControllerDeleteChannelConnectionRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.nil(
      204,
      operations.ChannelConnectionsControllerDeleteChannelConnectionResponse$inboundSchema.optional()
    ),
