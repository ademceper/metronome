...
> {
  return new APIPromise(
    $do(client, subscriberId, providerId, idempotencyKey, options)
  )
}
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.SubscribersV1ControllerDeleteSubscriberCredentialsRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.nil(
      204,
      operations.SubscribersV1ControllerDeleteSubscriberCredentialsResponse$inboundSchema.optional(),
      { hdrs: true }
    ),
