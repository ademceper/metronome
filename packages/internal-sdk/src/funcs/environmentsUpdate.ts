...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.EnvironmentsControllerV1UpdateMyEnvironmentRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.EnvironmentsControllerV1UpdateMyEnvironmentResponse$inboundSchema,
