...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.EnvironmentVariablesControllerDeleteEnvironmentVariableRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.nil(
      204,
      operations.EnvironmentVariablesControllerDeleteEnvironmentVariableResponse$inboundSchema.optional(),
      { hdrs: true }
    ),
