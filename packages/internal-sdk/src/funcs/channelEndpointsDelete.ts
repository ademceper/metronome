...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ChannelEndpointsControllerDeleteChannelEndpointRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.nil(
      204,
      operations.ChannelEndpointsControllerDeleteChannelEndpointResponse$inboundSchema.optional()
    ),
