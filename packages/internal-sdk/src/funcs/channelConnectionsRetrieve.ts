...
> {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ChannelConnectionsControllerGetChannelConnectionByIdentifierRequest$outboundSchema.parse(
        value
      ),
  ...
  >(
    M.json(
      200,
      operations.ChannelConnectionsControllerGetChannelConnectionByIdentifierResponse$inboundSchema,
