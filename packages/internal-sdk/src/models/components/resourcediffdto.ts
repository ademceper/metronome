...
> = z.object({
  ...
  updatedBy: z
    .nullable(z.lazy(() => ResourceDiffDtoUpdatedBy$inboundSchema))
    .optional(),
  updatedAt: z
    .nullable(
      z
...
/** @internal */
export const Diffs$inboundSchema: z.ZodType<Diffs, z.ZodTypeDef, unknown> =
  z.object({
...
> = z.object({
  sourceResource: z
    .nullable(z.lazy(() => ResourceDiffDtoSourceResource$inboundSchema))
    .optional(),
  targetResource: z
    .nullable(z.lazy(() => ResourceDiffDtoTargetResource$inboundSchema))
    .optional(),
