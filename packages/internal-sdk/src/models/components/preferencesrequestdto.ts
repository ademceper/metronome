...
> = z.object({
  user: z
    .nullable(z.lazy(() => UserWorkflowPreferencesDto$outboundSchema))
    .optional(),
  workflow: z
    .nullable(z.lazy(() => PreferencesRequestDtoWorkflow$outboundSchema))
    .optional(),
})
