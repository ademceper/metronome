...
/** @internal */
export const GenerateConnectOauthUrlRequestDtoContext2$outboundSchema: z.ZodType<
...
export function generateConnectOauthUrlRequestDtoContextToJSON(
  generateConnectOauthUrlRequestDtoContext: GenerateConnectOauthUrlRequestDtoContext
): string {
  return JSON.stringify(
...
/** @internal */
export const GenerateConnectOauthUrlRequestDtoConnectionMode$outboundSchema: z.ZodNativeEnum<
  typeof GenerateConnectOauthUrlRequestDtoConnectionMode
> = z.nativeEnum(GenerateConnectOauthUrlRequestDtoConnectionMode)
...
> = z.object({
  ...
  connectionMode:
    GenerateConnectOauthUrlRequestDtoConnectionMode$outboundSchema.optional(),
