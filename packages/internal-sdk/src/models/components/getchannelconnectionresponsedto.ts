...
import { type AuthDto, AuthDto$inboundSchema } from "./authdto.js"
import {
  type WorkspaceDto,
  WorkspaceDto$inboundSchema,
...
/** @internal */
export const Channel$inboundSchema: z.ZodNativeEnum<typeof Channel> =
  z.nativeEnum(Channel)

/** @internal */
export const ProviderId$inboundSchema: z.ZodNativeEnum<typeof ProviderId> =
  z.nativeEnum(ProviderId)
