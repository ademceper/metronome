...
/** @internal */
export const ChannelEndpointsControllerDeleteChannelEndpointRequest$outboundSchema: z.ZodType<
...
export function channelEndpointsControllerDeleteChannelEndpointRequestToJSON(
  channelEndpointsControllerDeleteChannelEndpointRequest: ChannelEndpointsControllerDeleteChannelEndpointRequest
): string {
...
/** @internal */
export const ChannelEndpointsControllerDeleteChannelEndpointResponse$inboundSchema: z.ZodType<
...
> {
  return safeParse(
    jsonString,
    (x) =>
      ChannelEndpointsControllerDeleteChannelEndpointResponse$inboundSchema.parse(
        JSON.parse(x)
      ),
