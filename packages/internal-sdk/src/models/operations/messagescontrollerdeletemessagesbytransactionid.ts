...
/** @internal */
export const MessagesControllerDeleteMessagesByTransactionIdQueryParamChannel$outboundSchema: z.ZodNativeEnum<
  typeof MessagesControllerDeleteMessagesByTransactionIdQueryParamChannel
> = z.nativeEnum(
  MessagesControllerDeleteMessagesByTransactionIdQueryParamChannel
)
...
> = z
  .object({
    channel:
      MessagesControllerDeleteMessagesByTransactionIdQueryParamChannel$outboundSchema.optional(),
...
> {
  return safeParse(
    jsonString,
    (x) =>
      MessagesControllerDeleteMessagesByTransactionIdResponse$inboundSchema.parse(
        JSON.parse(x)
      ),
