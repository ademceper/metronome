...
/** @internal */
export const ChannelEndpointsControllerCreateChannelEndpointRequestBody$outboundSchema: z.ZodType<
...
export function channelEndpointsControllerCreateChannelEndpointRequestBodyToJSON(
  channelEndpointsControllerCreateChannelEndpointRequestBody: ChannelEndpointsControllerCreateChannelEndpointRequestBody
): string {
  return JSON.stringify(
    ChannelEndpointsControllerCreateChannelEndpointRequestBody$outboundSchema.parse(
      channelEndpointsControllerCreateChannelEndpointRequestBody
    )
  )
}
...
/** @internal */
export const ChannelEndpointsControllerCreateChannelEndpointRequest$outboundSchema: z.ZodType<
...
export function channelEndpointsControllerCreateChannelEndpointRequestToJSON(
  channelEndpointsControllerCreateChannelEndpointRequest: ChannelEndpointsControllerCreateChannelEndpointRequest
): string {
  return JSON.stringify(
...
/** @internal */
export const ChannelEndpointsControllerCreateChannelEndpointResponse$inboundSchema: z.ZodType<
...
> {
  return safeParse(
    jsonString,
    (x) =>
      ChannelEndpointsControllerCreateChannelEndpointResponse$inboundSchema.parse(
        JSON.parse(x)
      ),
