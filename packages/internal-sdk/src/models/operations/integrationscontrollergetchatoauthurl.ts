...
export type IntegrationsControllerGetChatOAuthUrlRequest$Outbound = {
  ...
  GenerateChatOauthUrlRequestDto: components.GenerateChatOauthUrlRequestDto$Outbound
}

/** @internal */
export const IntegrationsControllerGetChatOAuthUrlRequest$outboundSchema: z.ZodType<
...
export function integrationsControllerGetChatOAuthUrlRequestToJSON(
  integrationsControllerGetChatOAuthUrlRequest: IntegrationsControllerGetChatOAuthUrlRequest
): string {
...
/** @internal */
export const IntegrationsControllerGetChatOAuthUrlResponse$inboundSchema: z.ZodType<
