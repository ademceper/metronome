...
export function DetailTextWithValue({
  value,
  prefix = "",
  suffix = "",
  valueStyle,
  style,
}: DetailTextWithValueProps) {
...
const NOVU_LOGO_URL =
  "https://dashboard.novu.co/images/report-emails/novu-logo-dark.png"
...
const PROVIDER_CONFIG: Record<string, { name: string; id: string }> =
  Object.fromEntries(
...
function mapProviders(
  providers: PayloadSchemaType["topProviders"]
): ITopProvider[] {
  return providers
    .map((provider) => {
    ...
    <>
      {Array.from({ length: count }).map((_, idx) => (
        <Row key={`placeholder-${idx}`} style={{ margin: "0", padding: "3px" }}>
          <Column>
            <span style={{ fontSize: "8px", color: "transparent" }}>
              &nbsp;
            </span>
          </Column>
            ...
            <Row key={idx} style={{ margin: "0", padding: "3px" }}>
              <Column>
                <Row>
                  ...
                  <Column
                    style={{ padding: "0 0 0 4px", verticalAlign: "middle" }}
                  >
                    <Text
                      style={{
                        fontSize: "12px",
              ...
              <Column style={{ ...listValueCellStyle }}>
                {humanizeNumber(item.count)}
              </Column>
            </Row>
          )
        })}
              ...
              <Row>
                <Column>
                  ...
                  >
                    ...
                    <Text style={{ color: "#525866" }}>
                      {humanizeNumber(topChannel.value)} messages
                    </Text>{" "}
                    sent
                    <br />
                      ...
                      <Section style={{ width: "100%" }}>
                        <Row>
                          ...
                          >
                            ...
                            >
                              <Text style={{ color: "#0E121B" }}>
                                {humanizeNumber(channel.value)}{" "}
                              </Text>
  ...
  return (
    <Section style={{ textAlign: "center", padding: "24px 0" }}>
      ...
      <Text style={{ marginTop: "12px", marginBottom: "0" }}>
        <Link
          href="https://linkedin.com/company/novuco"
...
export function UsageReportEmail({
  ...
  props: PayloadSchemaType & ControlValueSchema
}) {
  const {
    dateRangeFrom,
    dateRangeTo,
