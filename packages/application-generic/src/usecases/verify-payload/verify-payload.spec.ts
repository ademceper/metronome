...
import { type ITemplateVariable, TemplateVariableTypeEnum } from "@novu/shared"
...
describe("Verify Payload Usecase", () => {
  ...
  it("should not allow false types", () => {
    ...
    expect(() => {
      ...
      "payload is missing required key(s) and type(s): first (Value), second (Array), third (Boolean)"
    )
  })
})
