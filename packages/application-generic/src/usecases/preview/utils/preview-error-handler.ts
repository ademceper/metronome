...
const ERROR_CONTENT_MAPPINGS: Record<string, ErrorContent> = {
  ...
  STEP_RESOLVER_UNAVAILABLE: {
    ...
    getMessage: () =>
      'Your step template code is unavailable. Try running "npx novu step publish" to redeploy.',
    hint: "This is not a problem with your template code.",
  },
  STEP_RESOLVER_NOT_FOUND: {
    title: "Preview unavailable",
    getMessage: () =>
      'No published step template code found. Run "npx novu step publish" to deploy your templates.',
    hint: "This is not a problem with your template code.",
  },
  ...
  STEP_RESOLVER_TIMEOUT: {
    title: "Preview unavailable",
    getMessage: () =>
      "Your step template took too long to render. Check for slow operations in your template code.",
    hint: "This is not a problem with your template code.",
  },
  STEP_RESOLVER_ERROR: {
    title: "Preview unavailable",
    getMessage: () =>
      'Failed to reach your step template code. Try running "npx novu step publish" to redeploy.',
    hint: "This is not a problem with your template code.",
  },
...
export class PreviewErrorHandler {
  ...
  extractErrorContent(error: unknown): {
    title: string
    message: string
    hint: string
  } {
