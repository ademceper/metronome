...
const mapDetailToEventType = {
  ...
  [DetailEnum.STEP_FILTERED_BY_SUBSCRIBER_WORKFLOW_PREFERENCES]:
    "step_filtered",
  ...
  [DetailEnum.SUBSCRIBER_MISSING_EMAIL_ADDRESS]:
    "subscriber_missing_email_address",
  [DetailEnum.SUBSCRIBER_MISSING_PHONE_NUMBER]:
  ...
  [DetailEnum.SUBSCRIBER_NOT_MEMBER_OF_ORGANIZATION]:
  ...
  [DetailEnum.RESPONSE_SCHEMA_VALIDATION_FAILED]:
  ...
  [DetailEnum.STEP_RESOLVER_EXECUTION_TIMEOUT]:
  ...
  [DetailEnum.MSTEAMS_INSUFFICIENT_PERMISSIONS]:
  ...
  [DetailEnum.REPLY_CALLBACK_MISSING_REPLAY_CALLBACK_URL]:
...
export class CreateExecutionDetails {
  ...
  private async createTraceLogEntry(
  ...
  private mapExecutionStatusToTraceStatus(
