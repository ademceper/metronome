...
export function toResponseWorkflowDto(
  ...
  return {
    ...
    issues: workflow.issues as unknown as Record<
...
function toMinifiedWorkflowDto(
...
function buildStepTypeOverview(
  step: NotificationStepEntity
...
function computeOrigin(
  ...
  if (
    ...
    typeof template.origin === "undefined"
  ) {
