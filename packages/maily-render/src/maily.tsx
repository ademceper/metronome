...
export class Maily {
  ...
  private getMarginOverrideConditions(
    ...
    const isParentBlockQuote =
      parent?.type === "blockquote" && node.type !== "blockquote"
  ...
  private paragraph(node: JSONContent, options?: NodeOptions): JSX.Element {
    ...
    const marginBottom =
      isParentListItem || shouldRemoveBottomMargin ? 0 : DEFAULT_MARGIN
  ...
  private heading(node: JSONContent, options?: NodeOptions): JSX.Element {
    ...
    const { fontSize, fontStyle, fontWeight, lineHeight } =
