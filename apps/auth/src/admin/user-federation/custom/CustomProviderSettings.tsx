 ...
 *
 * $ npx keycloakify own --path "admin/user-federation/custom/CustomProviderSettings.tsx" --revert
 */
...
import type { CustomUserFederationRouteParams } from "../paths/CustomUserFederation";
