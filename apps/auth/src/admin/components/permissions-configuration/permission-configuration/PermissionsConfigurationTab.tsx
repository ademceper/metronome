 ...
 *
 * $ npx keycloakify own --path "admin/permissions-configuration/permission-configuration/PermissionsConfigurationTab.tsx" --revert
 */
...
import { AuthorizationScopesDetails } from "./AuthorizationScopesDetails";
