 ...
 *
 * $ npx keycloakify own --path "admin/user-federation/UserFederationSection.tsx" --revert
 */
...
import { ClickableCard } from "../keycloak-card/clickable-card";
import { KeycloakCard } from "../keycloak-card/keycloak-card";
