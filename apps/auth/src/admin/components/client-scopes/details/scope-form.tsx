 ...
 *
 * $ npx keycloakify own --path "admin/client-scopes/details/ScopeForm.tsx" --revert
 */
...
} from "../../client-scope/client-scope-types";
...
import { removeEmptyOid4vcAttributes } from "./oid4vci-attributes";
