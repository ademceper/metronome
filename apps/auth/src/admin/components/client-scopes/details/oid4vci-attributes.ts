 ...
 *
 * $ npx keycloakify own --path "admin/client-scopes/details/oid4vciAttributes.ts" --revert
 */
...
import { ClientScopeDefaultOptionalType } from "../../client-scope/client-scope-types";
