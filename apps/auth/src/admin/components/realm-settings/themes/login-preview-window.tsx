 ...
 *
 * $ npx keycloakify own --path "admin/realm-settings/themes/LoginPreviewWindow.tsx" --revert
 */
...
import { loginThemeProperties as properties } from "./login-theme-properties";
