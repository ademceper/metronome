 ...
 *
 * $ npx keycloakify own --path "admin/realm-settings/RealmSettingsTabs.tsx" --revert
 */
...
import { ClientPoliciesTab, toClientPolicies } from "../../lib/realm-settings";
import { RealmSettingsTab, toRealmSettings } from "../../lib/realm-settings";
