...
import { ClientScope, RequiredIdValue } from "../../../../../../components/clients/authorization/policy/client-scope";
import { Group, GroupValue } from "../../../../../../components/clients/authorization/policy/group";
import { JavaScript } from "../../../../../../components/clients/authorization/policy/java-script";
import { LogicSelector } from "../../../../../../components/clients/authorization/policy/logic-selector";
...
export const Route = createFileRoute("/$realm/permissions/$permissionClientId/policies/$policyId/$policy-type")({
